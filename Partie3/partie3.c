...
pthread_rwlock_t lock2 = PTHREAD_RWLOCK_INITIALIZER;
pthread_rwlock_t lock3 = PTHREAD_RWLOCK_INITIALIZER;
pthread_rwlock_t fifo = PTHREAD_RWLOCK_INITIALIZER;
...
void* TrainUn(void *p){
    ...
    while (i >= 0 ){
        ...
        pthread_rwlock_rdlock(&fifo); // file d'attente Train2 et Train3
        ...
        pthread_rwlock_unlock(&lock1);//on verrouille le mutex de Train1 pour déverrouiller le mutex de Train2 et Train3
        pthread_rwlock_unlock(&fifo);
...
void* TrainDeux(void *p){
    ...
    while (i >= 0 ){
        ...
        pthread_rwlock_rdlock(&fifo);// file d'attente Train1 et Train3
        pthread_rwlock_rdlock(&lock2);
        ...
        pthread_rwlock_unlock(&lock2);//on verrouille le mutex de Train2 pour déverrouiller le mutex de Train1 et Train3
        pthread_rwlock_unlock(&fifo);
